...
export class AlgorandService {
  ...
  async checkIfAccountHasAsset(address: string, assetId: string): Promise<boolean> {
    try {
      const res = await this.algodClient.accountAssetInformation(address, Number(assetId)).do();
